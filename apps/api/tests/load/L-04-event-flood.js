...
const FLAG_KEYS = ["boolean-test-flag", "rollout-test-flag", "user-targeting-test-flag", "ab-test-flag"];
...
export default function () {
    ...
    if (res.status >= 500) {
        serverErrors.add(1);
        console.error(`VU ${__VU} iter ${__ITER}: 5xx on event flush — ${res.body}`);
    }
